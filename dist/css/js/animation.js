 ...
 * License : MIT
 * Author : wahyu9kdl (http://wahyu9kdl.github.io)
 */
;(function (factory) {
  'use strict';
    ...
    init: function(options){
      ...
      if(!support && options.browser.length > 0){
        if(!support || !this.length){
          ...
          if(!this.length) console.log('Animation: Element does not exist on page.');
          if(!support) console.log('Animation: Does not support this browser.');
